      ...
      >
        <div
          className={cn(
            ...
            !hideClearAllButton && "pe-9 cursor-pointer",
            className,
          )}
          onClick={() => {
            if (disabled) return
        ...
        >
          <div className="flex flex-wrap gap-1 cursor-pointer">
            {selected.map((option) => {
              return (
                ...
                >
                  {option.label}
                  <button
                    className="absolute -inset-y-px -end-px flex size-7 items-center justify-center rounded-e-lg border border-transparent p-0 text-muted-foreground/80 outline-0 transition-colors hover:text-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 cursor-pointer"
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
            ...
            <button
              ...
              className={cn(
                "absolute end-0 top-0 flex size-9 items-center justify-center rounded-lg border border-transparent text-muted-foreground/80 transition-colors hover:text-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 cursor-pointer",
                (hideClearAllButton ||
                  disabled ||
                  selected.length < 1 ||
